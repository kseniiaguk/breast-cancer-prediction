...
def prepare_lbp():
    x_train = pd.read_csv('lbp.csv')
    x_train.drop('Label', inplace=True, axis=1)
    x_train.drop(x_train.columns[0], inplace=True, axis=1)
    y_train = pd.read_csv('lbp.csv', usecols=['Label'])
    return x_train, y_train
...
def prepare_law():
    x_train = pd.read_csv('law.csv')
    x_train.drop('Label', inplace=True, axis=1)
    x_train.drop(x_train.columns[0], inplace=True, axis=1)
    y_train = pd.read_csv('law.csv', usecols=['Label'])
    return x_train, y_train
